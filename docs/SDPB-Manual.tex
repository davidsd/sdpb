...
The program \texttt{sdp2input} generates files of the form in
listing~\ref{xmlinputformat} starting from \texttt{Mathematica} data.
...
SDPB started at 2018-Oct-23 15:01:09
...
debug                        = false
          ...
          time    mu     P-obj       D-obj      gap         P-err       D-err      P-step   D-step   beta  dim
---------------------------------------------------------------------------------------------------------------
1            0 1.0e+40  +0.00       +0.00       0.00       +1.00e+20   +2.88e+20   0.811    0.832    0.300  1
2            0 2.7e+39  +1.22e+20   -2.11e+20   1.00       +1.89e+19   +4.84e+19   0.786    0.807    0.300  1
3            0 8.4e+38  +1.27e+20   -3.52e+20   1.00       +4.03e+18   +9.36e+18   0.777    0.794    0.300  1
....
82           0 2.4e-08  +1.84       +1.84       3.22e-08   +4.33e-136  +1.79e-134  1.00     1.00     0.100  1
83           0 2.4e-09  +1.84       +1.84       3.22e-09   +6.99e-136  +4.27e-134  1.00     1.00     0.100  1
84           0 2.4e-10  +1.84       +1.84       3.22e-10   +3.13e-136  +2.20e-134  1.00     1.00     0.100  1
-----found primal-dual optimal solution-----

primalObjective = 1.84026576320318090039117617247403804326445555507439934672628612807738555109679854789376606
1435193498261234053161410573076634281729848342
dualObjective   = 1.84026576308462848033006313255001428991959547020992950642901598201900422505389883109900102
0847250942430618468768821243142382243330096089
dualityGap      = 3.22106791408699658310926876653734497767736974296331635819280399407159685692585961407171090
6339045160904020559956169061628872411051464635e-11
primalError     = 5.00037755305806798164436957351900929576913325025196268071859152540745147053008175998854705
8919012324798467335629270560162565523345346961e-136
dualError       = 1.19696429334187360543910708477679566903833954579370699383899312769928337120183911303802430
2618468190683390894684227272207711446465027672e-133
...
\item[\texttt{dim}:] The dimension of the vector $y$.
\end{description}
...
\cite{GMP}, \texttt{MPC} \cite{MPC}, and \texttt{MPFR}
\cite{MPFR}.
...
\bibitem{MPC}
  The GNU MPC Library,
  \href{http://www.multiprecision.org/mpc}{http://www.multiprecision.org/mpc}

...
Singularity image is named `sdpb-3.1.0.sif`, you can invoke the SDPB
programs by prepending the command with

    singularity exec sdpb-3.1.0.sif

So to convert the JSON input file at `/home/user/input.json`, run the command

    singularity exec sdpb-3.1.0.sif mpirun -n 4 pmp2sdp --precision 1024 -i /home/user/input.json -o /home/user/input
...
To find a primal-dual solution, 
    ...
    singularity exec sdpb-3.1.0.sif mpirun -n 4 sdpb --precision=1024 -s /home/user/input

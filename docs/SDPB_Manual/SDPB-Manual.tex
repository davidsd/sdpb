...
The \texttt{JSON} format is described by the schema in \texttt{docs/json\_schema/pmp\_schema.json}.
...
Module[
  ...
  WriteBootstrapSDP["pmp.xml", SDP[obj, norm, pols]];
];
\end{lstlisting}
It produces the following XML file
\begin{lstlisting}[
  caption={XML file \texttt{pmp.xml} produced by listing~\ref{mathematicaexample}.  Decimals are truncated at 12 digits.},

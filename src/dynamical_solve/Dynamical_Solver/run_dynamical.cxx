  ...
  for(;; ++iteration)
    {
      ...
      El::BigFloat beta_predictor;
      {
        ...
        dynamical_step(dynamical_parameters, total_psd_rows,
                       is_primal_and_dual_feasible, block_info, sdp, grid,
                       X_cholesky, Y_cholesky, A_X_inv, A_Y, primal_residue_p,
                       mu, beta_predictor, primal_step_length,
                       dual_step_length, terminate_now, timers, update_sdp,
                       find_zeros, extParamStep);

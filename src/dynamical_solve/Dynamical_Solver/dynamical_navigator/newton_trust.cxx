...
void newton_search1d(const El::BigFloat &thresh, const int &it,
                     const El::Matrix<El::Base<El::BigFloat>> &w,
                     El::BigFloat &lambda,
                     const El::Matrix<El::BigFloat> &e_dot_grad,
...
void trust_region_boundary_step(const El::BigFloat &thresh, const int &max_it,
                                const El::BigFloat &radius,
                                El::Matrix<El::BigFloat> &A,
                                const El::Matrix<El::BigFloat> &grad,
                                El::Matrix<El::BigFloat> &step)
{
  ...
  //cout << "1d search "<< endl;
  newton_search1d(thresh, max_it, w, lambda, e_dot_grad, radius,
                  n_external_parameters);
  El::Zero(step);

...
Timers solve(const Block_Info &block_info, const Dynamic_Parameters &parameters)
{
  ...
  SDP_Solver_Terminate_Reason reason(solver.run_dynamic(
    ...
    parameters_tree, block_info, grid, timers, update_sdp, extParamStep));
  ...
  save_solution(solver, reason, update_sdp, timers.front(), parameters.out_directory,

...
// TODO reuse sdpb/write_timing.cxx
// note that prefix will be different
                  ...
                  El::Matrix<int32_t> &block_timings)
{
  ...
  std::string Q_prefix = "dynamical_sdp.solve.run.iter_2.dynamical_step."
                         "initializeSchurComplementSolver.Q.";

...
void write_timing(const std::filesystem::path &checkpoint_out,
  ...
  try
    {
      ...
      if(El::mpi::Size(El::mpi::COMM_WORLD) > 1
                    ...
                    / "checkpoint.0"))
        {
          ...
          write_timing(
            ...
            block_info, timers,
            timing_parameters.verbosity >= Verbosity::debug, block_timings);
      ...
      solve(block_info, parameters, env, start_time);
    }

                                          ...
                                          Function_Blocks_Parser>
{
  ...
  Vector_State<Number_State<El::BigFloat>> objective_state,
    normalization_state;
  Vector_State<Vector_State<Vector_State<Vector_State<
    Map_State<Number_State<El::BigFloat>, Number_State<El::BigFloat>>>>>>
    functions_state;

  Function_Blocks_Parser()
      : objective_state({"objective"s, ""s}),
        normalization_state({"normalization"s, ""s}),
        functions_state({"functions"s, ""s, ""s, ""s, ""s, ""s, ""s})
  {}

...
#include "sdp_solve/SDP_Solver/load_checkpoint/load_binary_checkpoint.hxx"
...
{
  void
  load_local_binary_data(SDP_Solver &solver, std::ifstream &checkpoint_stream)
  {
    read_local_binary_matrix(solver.x, checkpoint_stream);

...
def build(bld):
    ...
    bld.program(source=['src/pvm2sdp/main.cxx',
                        ...
                        'src/pvm2sdp/read_input_files.cxx'],
                target='pvm2sdp',
                cxxflags=default_flags,
                defines=default_defines,
                includes=default_includes,
    ...
    sdp_read_sources = ['src/sdp_read/polynomial_matrices_with_prefactor/PMWP_File_Parse_Result.cxx',
                        ...
                        'src/sdp_read/polynomial_vector_matrices/PVM_File_Parse_Result.cxx',
                        'src/sdp_read/polynomial_vector_matrices/PVM_SDP.cxx',
                        'src/sdp_read/polynomial_vector_matrices/read_xml/read_xml.cxx',
                        'src/sdp_read/polynomial_vector_matrices/read_xml/Input_Parser/on_start_element.cxx',
                        'src/sdp_read/polynomial_vector_matrices/read_xml/Input_Parser/on_end_element.cxx',
                        'src/sdp_read/polynomial_vector_matrices/read_xml/Input_Parser/on_characters.cxx',

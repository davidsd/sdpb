...
def build(bld):
    ...
    bld.program(source=['src/main.cxx',
                        ...
                        'src/solve/SDP/SDP/parse_Real.cxx',
                        ...
                        'src/solve/SDP_Solver/run/constraint_matrix_weighted_sum/constraint_matrix_weighted_sum.cxx',
                        'src/solve/SDP_Solver/run/constraint_matrix_weighted_sum/diagonal_congruence.cxx',
                        ...
                        'src/solve/SDP_Solver/run/compute_search_direction/compute_schur_RHS/bilinear_block_pairing.cxx',
                        'src/solve/SDP_Solver/run/compute_search_direction/compute_schur_RHS/compute_schur_RHS.cxx',

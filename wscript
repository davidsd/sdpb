...
def build(bld):
    ...
    pmp_read_sources = ['src/pmp_read/collect_files_expanding_nsv.cxx',
                        ...
                        'src/pmp_read/read_json/Json_Polynomial_Vector_Matrix_State/json_key.cxx',
                        'src/pmp_read/read_json/Json_Polynomial_Vector_Matrix_State/json_string.cxx',
                        'src/pmp_read/read_json/Json_Polynomial_Vector_Matrix_State/json_start_array.cxx',
                        'src/pmp_read/read_json/Json_Polynomial_Vector_Matrix_State/json_end_array.cxx',
                        'src/pmp_read/read_json/Json_Polynomial_Vector_Matrix_State/json_start_object.cxx',
                        'src/pmp_read/read_json/Json_Polynomial_Vector_Matrix_State/json_end_object.cxx',
                        'src/pmp_read/read_json/Damped_Rational_State/json_key.cxx',
                        'src/pmp_read/read_json/Damped_Rational_State/json_string.cxx',
                        'src/pmp_read/read_json/Damped_Rational_State/json_start_array.cxx',
                        'src/pmp_read/read_json/Damped_Rational_State/json_end_array.cxx',
                        'src/pmp_read/read_json/Damped_Rational_State/json_start_object.cxx',
                        'src/pmp_read/read_json/Damped_Rational_State/json_end_object.cxx',
                        'src/pmp_read/read_json/JSON_Parser/Key.cxx',
                        'src/pmp_read/read_json/JSON_Parser/String.cxx',
                        'src/pmp_read/read_json/JSON_Parser/StartArray.cxx',
                        'src/pmp_read/read_json/JSON_Parser/EndArray.cxx',
                        'src/pmp_read/read_json/JSON_Parser/StartObject.cxx',
                        'src/pmp_read/read_json/JSON_Parser/EndObject.cxx',
    ...
    bld.program(source=['external/catch2/catch_amalgamated.cpp',
                ...
                cxxflags=default_flags,
                defines=default_defines + ['CATCH_AMALGAMATED_CUSTOM_MAIN'],
                use=use_packages + ['pmp2sdp', 'sdp_solve'],
                includes=default_includes + ['test/src']
                )

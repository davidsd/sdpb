...
def build(bld):
    ...
    bld.program(source=['src/outer_limits/main.cxx',
                        ...
                        'src/outer_limits/read_points/Points_Parser/EndArray.cxx',
                        'src/outer_limits/read_points/Points_Parser/EndObject.cxx',
                        'src/outer_limits/read_points/Points_Parser/Key.cxx',
                        'src/outer_limits/read_points/Points_Parser/StartArray.cxx',
                        'src/outer_limits/read_points/Points_Parser/StartObject.cxx',
                        'src/outer_limits/read_points/Points_Parser/String.cxx',

...
def build(bld):
    ...
    bld.program(source=['src/sdp2blocks/main.cxx',
                        ...
                        'src/sdp2blocks/read_input/read_mathematica/parse_SDP/parse_polynomial.cxx',
                        'src/sdp2blocks/read_input/read_mathematica/parse_SDP/parse_matrix/parse_matrix.cxx',
                        'src/sdp2blocks/read_input/read_mathematica/parse_SDP/parse_matrix/parse_damped_rational.cxx',

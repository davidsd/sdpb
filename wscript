...
def build(bld):
    ...
    bld.program(source=['src/sdpb/main.cxx',
                        ...
                        'src/sdpb/solve/SDP_Solver/run/initialize_schur_complement_solver/initialize_schur_complement_solver.cxx',
                        'src/sdpb/solve/SDP_Solver/run/initialize_schur_complement_solver/compute_schur_complement.cxx',
                        'src/sdpb/solve/SDP_Solver/run/initialize_schur_complement_solver/synchronize/synchronize.cxx',
                        'src/sdpb/solve/SDP_Solver/run/initialize_schur_complement_solver/synchronize/reduce_and_scatter.cxx',

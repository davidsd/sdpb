...
def build(bld):
    ...
    bld.program(source=['src/sdp2blocks/main.cxx',
                        ...
                        'src/sdp2blocks/read_input/read_mathematica/read_mathematica.cxx',
                        'src/sdp2blocks/read_input/read_mathematica/parse_SDP/parse_SDP.cxx',
                        'src/sdp2blocks/read_input/read_mathematica/parse_SDP/parse_number.cxx',
                        'src/sdp2blocks/read_input/read_mathematica/parse_SDP/parse_matrices/parse_matrices.cxx',
                        'src/sdp2blocks/read_input/read_mathematica/parse_SDP/parse_matrices/parse_matrix/parse_matrix.cxx',
                        'src/sdp2blocks/read_input/read_mathematica/parse_SDP/parse_matrices/parse_matrix/parse_damped_rational.cxx',
                        'src/sdp2blocks/write_output/write_output.cxx',
                        'src/sdp2blocks/write_output/sample_points.cxx',
                        'src/sdp2blocks/write_output/bilinear_basis/bilinear_basis.cxx',
                        'src/sdp2blocks/write_output/bilinear_basis/precompute/precompute.cxx',
                        'src/sdp2blocks/write_output/bilinear_basis/precompute/integral.cxx',
                        'src/sdp2blocks/write_output/bilinear_basis/bilinear_form/bilinear_form.cxx',
                        'src/sdp2blocks/write_output/bilinear_basis/bilinear_form/rest.cxx',
                        'src/sdp2blocks/write_output/bilinear_basis/bilinear_form/dExp.cxx',
                        'src/sdp2blocks/write_output/bilinear_basis/bilinear_form/derivative.cxx',

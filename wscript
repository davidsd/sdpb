...
def build(bld):
    ...
    bld.program(source=['src/sdpb/main.cxx',
                        ...
                        'src/sdpb/solve/Block_Info/Block_Info.cxx',
                        ...
                        'src/sdpb/solve/SDP_Solver/run/compute_dual_residues.cxx',
                        'src/sdpb/solve/SDP_Solver/run/dot.cxx',
                        'src/sdpb/solve/SDP_Solver/run/block_tensor_inv_transpose_congruence_with_cholesky.cxx',
                        ...
                        'src/sdpb/solve/SDP_Solver/run/compute_primal_residues.cxx',
                        ...
                        'src/sdpb/solve/SDP_Solver/print_header.cxx',

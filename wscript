...
def build(bld):
    ...
    bld.program(source=['src/sdpb/main.cxx',
                        ...
                        'src/sdpb/solve/SDP_Solver/run/compute_A_X_inv_A_Y/compute_A_X_inv_A_Y.cxx',
                        'src/sdpb/solve/SDP_Solver/run/compute_A_X_inv_A_Y/compute_A_X_inv.cxx',
                        'src/sdpb/solve/SDP_Solver/run/compute_A_X_inv_A_Y/compute_A_Y.cxx',
                        ...
                        'src/sdpb/solve/SDP_Solver/run/step/initialize_schur_complement_solver/synchronize_Q/reduce_and_scatter.cxx',

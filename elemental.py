...
def configure(conf):
    ...
    if conf.options.elemental_incdir:
        elemental_incdir=[conf.options.elemental_incdir]
    else:
        elemental_incdir=[]
    if conf.options.elemental_libdir:
        elemental_libdir=[conf.options.elemental_libdir]
    else:
        elemental_libdir=[]
    ...
    if conf.options.elemental_libs:
        ...
        elemental_libs=['El', 'pmrrr', 'ElSuiteSparse', 'pthread', 'm', 'qd', 'mpc',
                        'mpfr', 'gmp', 'parmetis', 'metis' ]
